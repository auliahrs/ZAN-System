...
<head>
    ...
    <style>
        ...
        body {
            background-image: url(/ZAN-System/images/Background.png);
            position: absolute;
            width: 1300px;
            height: 300px;
        }
...
<body>
    ...
    <body>
        <img src="/ZAN-System/loginHeader.png" alt="Login Header"><br>
        ...
        <div class="loginform">
            <form action="/ZAN-System/applicantProfileView" method="POST">
                ...
                <a href="/ZAN-System/forgotPass">Forgot Password?</a>
                <a href="/ZAN-System/register">Register</a>
