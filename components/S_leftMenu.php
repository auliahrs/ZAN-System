<div class="col-md-2">
    ...
    <div class="menu-box">
        ...
        <a href="/ZAN-System/ManageIncentiveRegistration/Staff/updateRegForm.php">Senarai Pemohon</a>
        <a href="/ZAN-System/ManageMarriageIncentive/Staff/IncentiveForm.php">Pengesahan Permohonan</a>
    </div>
    <!-- Aduan box -->
    <div class="menu-box">
