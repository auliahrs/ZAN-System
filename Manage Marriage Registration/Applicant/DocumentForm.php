...
<head>
  ...
  <script>
    function goToOldInterface() {
      window.location.href = "/ZAN-System/marriageRegisterTypeView";
    }

    function goToNewInterface() {
      window.location.href = "/ZAN-System/paymentProofView";
    }
  </script>
</head>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-body">
              <form action="/ZAN-System/marriageRegisterView" method="post">
                <div class="row my-3">
