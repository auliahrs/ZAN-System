            ...
            <div class="content-body-staff">
              <div class="row">
                <div class="col table-dpp">
                  <form action="/ZAN-System/certCardGenerateCardFormView" method="get">
                  </form>
                </div>
              </div>
              <div class="row">
                <div class="col table-dpph">
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td> <button onclick="showLoadingAndPopup()">Jana Kad Perakuan Nikah bagi Pemohon</button>
                        ...
                        <script>
                          function showLoadingAndPopup() {
                            ...
                            setTimeout(function() {
                              ...
                              alert("Penjanaan Kad Perakuan Nikah akan diproses.");
                            }, 3000);
                          }
                        </script>
                      </td>
                  ...
                  <script>
                    function goToOldInterface() {
                      window.location.href = "/ZAN-System/certCardGeerateCertFormView";
                    }

                    function goToNewInterface() {
                      window.location.href = "/ZAN-System/certCardStatusFormView";
                    }
                  </script>
                </div>
              </div>
