            ...
            <div class="content-body-staff">
              <div class="row">
                <div class="col table-dpp">
                  <form action="/ZAN-System/certCardGeerateCertFormView" method="get">
                  </form>
                </div>
              </div>
              <div class="row">
                <div class="col table-dpph">
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td> <button onclick="showLoadingAndImage()">Jana Sijil Bagi Pemohon</button>
                        <div id="spinner" class="spinner"></div>
                        <div id="imageContainer" class="image-container"><img src="/ZAN-System/images/sijil.png" alt="Sijil Perkahwinan AHMAD AIMAN BIN ADAM"></div>
                        <script>
                      ...
                      <td><button onclick="showPopup()">Hantar</button>
                        <script>
                          function showPopup() {
                            alert("Sijil Bagi Pemohon sudah sedia dan dihantar");
                          }
                        </script>
                      </td>
                  ...
                  <script>
                    function goToNewInterface() {
                      window.location.href = "/ZAN-System/certCardGenerateCardFormView";
                    }
                  </script>
                </div>
              </div>
