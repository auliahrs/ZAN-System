...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if ($updateStmt->execute()) {
        ...
        header("Location: /ZAN-System/incentiveMaklumatPemohonView");
        exit();
    } else {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-body">
                            <form action="/ZAN-System/incentiveApplicationFormView" method="post" onsubmit="return confirm('Are you sure you want to save the data?');">
                                <div class="row my-3">
                                    <div class="col table-dpp link-button-general">
                                        ...
                                        <table class="upload">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="/ZAN-System/images/upload.png" height="30px"><input type="file" name="slipGaji">
                                                </td>
                                                <td>
                                        ...
                                        <div class="row my-3 link-button-general">
                                            <div class="col-md-6">
                                                <a href="/ZAN-System/incentiveMaklumatPemohonView">
                                                    < Kembali</a>
                                            </div>
                                            <div class="col-md-6">
